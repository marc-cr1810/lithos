...
private:
  ...
  void GenerateSand(int slotX, int slotY);
  void GenerateGravel(int slotX, int slotY);
  void GenerateSnow(int slotX, int slotY);
  void GenerateIce(int slotX, int slotY);

  // Flora
  void GenerateCactusSide(int slotX, int slotY);
  void GenerateCactusTop(int slotX, int slotY);
  void GenerateTallGrass(int slotX, int slotY);
  void GenerateDeadBush(int slotX, int slotY);
  void GenerateRose(int slotX, int slotY);
